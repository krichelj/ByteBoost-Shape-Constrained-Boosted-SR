...
Workshop project description for [ByteBoost 2026](https://byteboost.dev/) (ACCESS cyberinfrastructure testbeds). Discover neural scaling-law formulas with symbolic regression, while certifying physical priors (monotonicity, diminishing returns, positivity, irreducible floor, power-law decay) via interval-arithmetic forward-mode AD—across Cerebras (Neocortex) pretraining and A64FX (Ookami) search.
