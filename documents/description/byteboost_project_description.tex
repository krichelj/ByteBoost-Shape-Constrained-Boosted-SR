...
\codeRef{\pyFile{src/modeling/models/config.py}, \pyFile{src/modeling/models/llama.py}}
...
\codeRef{\pyDir{src/search/baselines}, \pyDir{src/search/residuals}, \pyDir{src/search/expression}, \pyDir{src/search/boosting}, \pyDir{src/search/hard_path}}
...
\cref{sec:boosting}, Alg.~\ref{alg:boosting-bb} & \pyDir{src/search} & \pyDir{src/search/baselines}, \pyDir{src/search/residuals}, \pyDir{src/search/expression}, \pyDir{src/search/boosting}, \pyDir{src/search/hard_path} \\
\cref{sec:soft} & \pyDir{src/search} & \pyDir{src/search/soft_path} \\
\cref{sec:models} & \pyDir{src/modeling} & \pyDir{src/modeling/models} \\
